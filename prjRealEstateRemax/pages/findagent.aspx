<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="findagent.aspx.cs" Inherits="prjRealEstateRemax.pages.findagent" EnableEventValidation="false" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
        <title>Remax | Find Agent</title>
    ...
    <form id="form1" runat="server" class="form-inline">
        ...
        <div class="slider-area">
            <div class="slider">
                <div id="bg-slider" class="owl-carousel owl-theme">
                    ...
                    <div class="item"><img src="../assets/img/slide1/slider-image-5.jpg" alt="" /></div>
                    <div class="item"><img src="../assets/img/slide1/slider-image-6.jpg" alt="" /></div>
                    ...
                    <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12">
                        ...
                        <div class="search-form wow pulse" data-wow-delay="0.8s">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtCode" runat="server" CssClass="form-control" placeholder="Agent number"></asp:TextBox>
                                </div>
                                <div class="form-group">                                   
                                    <asp:DropDownList ID="cboCityZone" runat="server" CssClass="selectpicker" data-live-search="true" data-live-search-style="begins" title="Select city zone">
                                    </asp:DropDownList>
                                </div>
                                <div class="form-group">
                                     <asp:DropDownList ID="cboLanguage" runat="server" CssClass="selectpicker" data-live-search="true" data-live-search-style="begins" title="Select language spoken">
                                    </asp:DropDownList>
                                </div>
                                ...
                                <div style="display: none;" class="search-toggle">
                                    ...
                                    <div class="search-row">   
                                        <div class="form-group mar-r-20">
                                            <label for="price-range">Gender:</label>
                                            <asp:DropDownList ID="cboGender" runat="server"  CssClass="selectpicker" data-live-search="true" data-live-search-style="begins" title="Select gender">
                                            </asp:DropDownList>
                                        </div>
                                        <!-- End of  -->  
                                    </div>
        ...
        <div class="content-area home-area-1 recent-property" style="background-color: #EAEAEA; padding-bottom: 55px;">
            <div class="container">
                ...
                <div class="row">
                    <div class="proerty-th" width="350" height ="350">
