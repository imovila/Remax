<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="housedetails.aspx.cs" Inherits="prjRealEstateRemax.pages.housedetails" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Remax | House details</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title">
                            <asp:Literal ID="litHouseTypeTitle" runat="server"></asp:Literal>&nbsp;in
                        ...
                        <div class="single-property-wrapper">
                            <div class="single-property-header">                                          
                                <h1 class="property-title pull-left">
                                    <asp:Literal ID="litHouseType" runat="server"></asp:Literal>&nbsp;in&nbsp;<asp:Literal ID="litCityZone" runat="server"></asp:Literal>
                                </h1>
                                <span class="property-price pull-right"><asp:Literal ID="litPrice" runat="server"></asp:Literal>&nbsp;CAD</span>
                            </div>
                            ...
                            <div class="property-meta entry-meta clearfix ">   
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                    ...
                                    <span class="property-info-entry">
                                        ...
                                        <span class="property-info-value"><asp:Literal ID="litHouseStatus" runat="server"></asp:Literal></span>
                                    </span>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                    ...
                                    <span class="property-info-entry">
                                        ...
                                        <span class="property-info-value"><asp:Literal ID="litAria" runat="server"></asp:Literal><b class="property-info-unit">&nbsp;m2</b></span>
                                    </span>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                    ...
                                    <span class="property-info-entry">
                                        ...
                                        <span class="property-info-value"><asp:Literal ID="litRooms" runat="server"></asp:Literal></span>
                                    </span>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                    ...
                                    <span class="property-info-entry">
                                        ...
                                        <span class="property-info-value"><asp:Literal ID="litBathrooms" runat="server"></asp:Literal></span>
                                    </span>
                                </div>
                            ...
                            <div class="section">
                                ...
                                <div class="s-property-content">
                                    <p><asp:Literal ID="litAddress" runat="server"></asp:Literal></p>
                                </div>
                            </div>
                            <!-- End address area -->

                            <div class="section">
                                <h4 class="s-property-title">Publication date</h4>
                                <div class="s-property-content">
                                    <p><asp:Literal ID="litDate" runat="server"></asp:Literal></p>
                                </div>
                            </div>
                            <!-- End publication date area -->
                                    ...
                                    <div class="inner-wrapper">
                                        ...
                                        <div class="clear">
                                            <div class="col-xs-4 col-sm-4 dealer-face">
                                                <a href="">
                                                    <asp:Literal ID="litAgentPic" runat="server"></asp:Literal>
                                                </a>
                                            </div>
                                            <div class="col-xs-8 col-sm-8 ">
                                                <h3 class="dealer-name">
                                                    <a href=""><asp:Literal ID="litAgenName" runat="server"></asp:Literal></a>
                                                    <br /><span>Remax Real Estate Agent</span>        
                                                </h3>
